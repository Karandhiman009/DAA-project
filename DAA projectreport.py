...
tk.Label(title_frame, text="Flight Route Planner", font=('Arial', 16, 'bold'), bg='#FF9933', fg='black').pack()
...
tk.Label(start_frame, text="Departure City:", font=('Arial', 11, 'bold'), bg='#EAEDED', fg='black').pack()

end_frame = tk.Frame(selection_frame, bg='#EAEDED')
end_frame.pack(side=tk.LEFT, padx=20)
tk.Label(end_frame, text="Arrival City:", font=('Arial', 11, 'bold'), bg='#EAEDED', fg='black').pack()

for city in graph.keys():
    tk.Radiobutton(start_frame, text=city, variable=start_city, value=city, bg='#EAEDED', fg='black', anchor=tk.W).pack(fill=tk.X)
    tk.Radiobutton(end_frame, text=city, variable=end_city, value=city, bg='#EAEDED', fg='black', anchor=tk.W).pack(fill=tk.X)

# Result Label
result_label = tk.Label(root, text="Your flight route will appear here.", wraplength=800, font=('Arial', 11), bg='#EAEDED', fg='black')
